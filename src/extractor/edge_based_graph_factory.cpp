...
{
    util::Percent progress("Edge-Expanded Nodes", 15, 20,m_node_based_graph->GetNumberOfNodes());
    ...
    const bool generate_edge_lookup)
{
    ...
    util::Percent progress("Edge-Expanded Edges", 20, 25,m_node_based_graph->GetNumberOfNodes());
